          ...
          {recentHistory &&
            recentHistory.map((item, index) => (
              ...
              key={index}
                ...
                className=" w-full px-5 pl-5 truncate dark:text-zinc-400 text-zinc-700 cursor-pointer dark:hover:bg-zinc-700 hover:bg-red-100 hover:text-zinc-200 dark:hover:text-zinc-200"
              >
                {item}
              </li>
